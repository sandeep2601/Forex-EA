...
static input int    Magic_Number = 2006269619; // Magic number
...
static input string ___0______   = "------"; // --- Bears Power ---
       input int    Ind0Param0   =        9; // Period
       input double Ind0Param1   =   0.0004; // Level

static input string ___1______   = "------"; // --- Moving Average of Oscillator ---
       input int    Ind1Param0   =       14; // Fast EMA
       input int    Ind1Param1   =       19; // Slow EMA
       input int    Ind1Param2   =       21; // MACD SMA
       input double Ind1Param3   =   0.0000; // Level

static input string ___2______   = "------"; // --- DeMarker ---
       input int    Ind2Param0   =       43; // Period
       input double Ind2Param1   =     0.33; // Level

static input string ___3______   = "------"; // --- Candle Color ---
       input int    Ind3Param0   =       10; // Min body height [pips]
       input int    Ind3Param1   =        6; // Consecutive candles
...
/*STRATEGY CODE {"properties":{"entryLots":1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":0,"takeProfit":0,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Bears Power","listIndexes":[4,0,0,0,0],"numValues":[9,0.0004,0,0,0,0]},{"name":"Moving Average of Oscillator","listIndexes":[0,3,0,0,0],"numValues":[14,19,21,0,0,0]}],"closeFilters":[{"name":"DeMarker","listIndexes":[5,0,0,0,0],"numValues":[43,0.33,0,0,0,0]},{"name":"Candle Color","listIndexes":[0,0,0,0,0],"numValues":[10,6,0,0,0,0]}]} */
