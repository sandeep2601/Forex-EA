...
static input int    Magic_Number = 1244545338; // Magic number
...
static input string ___0______   = "------"; // --- Moving Average ---
       ...
       input int    Ind0Param1   =        2; // Shift

static input string ___1______   = "------"; // --- Alligator ---
       input int    Ind1Param0   =       40; // Jaws period
       input int    Ind1Param1   =       23; // Jaws shift
       input int    Ind1Param2   =       39; // Teeth period
       input int    Ind1Param3   =        1; // Teeth shift
       input int    Ind1Param4   =        2; // Lips period
       input int    Ind1Param5   =        0; // Lips shift

static input string ___2______   = "------"; // --- Moving Averages Crossover ---
       input int    Ind2Param0   =       14; // Fast MA period
...
void InitIndicators(void)
  {
   // Moving Average (Simple, Close, 11, 2)
   ...
   // Alligator (Smoothed, Median, 40, 23, 39, 1, 2, 0)
   ...
   // Moving Averages Crossover (Simple, Simple, 14, 47)
...
/*STRATEGY CODE {"properties":{"entryLots":1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":0,"takeProfit":0,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Moving Average","listIndexes":[4,0,3,0,0],"numValues":[11,2,0,0,0,0]}],"closeFilters":[{"name":"Alligator","listIndexes":[7,3,4,0,0],"numValues":[40,23,39,1,2,0]},{"name":"Moving Averages Crossover","listIndexes":[0,0,0,0,0],"numValues":[14,47,0,0,0,0]}]} */
