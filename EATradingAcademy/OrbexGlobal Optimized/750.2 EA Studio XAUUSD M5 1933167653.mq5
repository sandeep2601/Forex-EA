...
static input int    Magic_Number = 1933167653; // Magic number
...
void InitIndicators(void)
  {
   ...
   // Envelopes (Close, Simple, 2, 0.15)
   indHandlers[0][2][0] = iEnvelopes(NULL, 0, Ind2Param0, 0, MODE_SMA, PRICE_CLOSE, Ind2Param1);
   if(Show_inds) ChartIndicatorAdd(0, 0, indHandlers[0][2][0]);
   // Bulls Power (1), Level: -0.0006
   indHandlers[0][3][0] = iBullsPower(NULL, 0, Ind3Param0);
...
void ManageClose(void)
  {
   ...
   bool   ind3short = ind3val1 > -Ind3Param1 + sigma && ind3val2 < -Ind3Param1 - sigma;
...
/*STRATEGY CODE {"properties":{"entryLots":1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":0,"takeProfit":0,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Bulls Power","listIndexes":[4,0,0,0,0],"numValues":[19,-0.0011,0,0,0,0]},{"name":"Directional Indicators","listIndexes":[2,0,0,0,0],"numValues":[1,0,0,0,0,0]}],"closeFilters":[{"name":"Envelopes","listIndexes":[1,3,0,0,0],"numValues":[2,0.15,0,0,0,0]},{"name":"Bulls Power","listIndexes":[5,0,0,0,0],"numValues":[1,-0.0006,0,0,0,0]}]} */
