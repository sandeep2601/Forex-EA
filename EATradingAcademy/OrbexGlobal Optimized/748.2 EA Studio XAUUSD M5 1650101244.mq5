...
static input int    Magic_Number = 1650101244; // Magic number
...
static input string ___0______   = "------"; // --- Bulls Power ---
       ...
       input double Ind0Param1   =  -0.0029; // Level

static input string ___1______   = "------"; // --- Pin Bar ---
       input int    Ind1Param0   =       12; // Max body part %
       input int    Ind1Param1   =       36; // Min wick part %

static input string ___2______   = "------"; // --- ADX ---
       input int    Ind2Param0   =       56; // Period
       input double Ind2Param1   =     38.9; // Level
...
void InitIndicators(void)
  {
   ...
   // ADX (56), Level: 38.9
   indHandlers[0][2][0] = iADX(NULL, 0, Ind2Param0);
...
/*STRATEGY CODE {"properties":{"entryLots":1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":0,"takeProfit":0,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Bulls Power","listIndexes":[5,0,0,0,0],"numValues":[8,-0.0029,0,0,0,0]}],"closeFilters":[{"name":"Pin Bar","listIndexes":[0,0,0,0,0],"numValues":[12,36,0,0,0,0]},{"name":"ADX","listIndexes":[5,0,0,0,0],"numValues":[56,38.9,0,0,0,0]}]} */
