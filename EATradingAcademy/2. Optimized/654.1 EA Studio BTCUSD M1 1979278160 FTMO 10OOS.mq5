...
static input int    Magic_Number = 1979278160; // Magic number
...
static input string ___0______   = "------"; // --- Stochastic ---
       ...
       input double Ind0Param3   =     60.6; // Level
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Stochastic","listIndexes":[5,0,0,0,0],"numValues":[6,2,4,60.6,0,0]}],"closeFilters":[{"name":"Accelerator Oscillator","listIndexes":[2,0,0,0,0],"numValues":[254,0,0,0,0,0]},{"name":"Awesome Oscillator","listIndexes":[3,0,0,0,0],"numValues":[-305,0,0,0,0,0]}]} */
