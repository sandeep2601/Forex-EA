...
static input int    Magic_Number = 1442701969; // Magic number
...
static input string ___0______   = "------"; // --- Bollinger Bands ---
       input int    Ind0Param0   =       20; // Period
       input double Ind0Param1   =     2.18; // Deviation

static input string ___1______   = "------"; // --- ADX ---
       input int    Ind1Param0   =       42; // Period
       input double Ind1Param1   =     26.7; // Level
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET Eightcap; XAUUSD; M1 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Bollinger Bands","listIndexes":[2,3,0,0,0],"numValues":[20,2.18,0,0,0,0]}],"closeFilters":[{"name":"ADX","listIndexes":[5,0,0,0,0],"numValues":[42,26.7,0,0,0,0]}]} */
