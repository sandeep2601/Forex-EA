...
static input int    Magic_Number = 1328086519; // Magic number
...
static input string ___0______   = "------"; // --- Moving Average of Oscillator ---
       input int    Ind0Param0   =        8; // Fast EMA
       input int    Ind0Param1   =       42; // Slow EMA
       input int    Ind0Param2   =        8; // MACD SMA
       input double Ind0Param3   =   0.3641; // Level
...
static input string ___2______   = "------"; // --- Standard Deviation ---
       ...
       input double Ind2Param1   =   6.5295; // Level

static input string ___3______   = "------"; // --- Candle Color ---
       input int    Ind3Param0   =       49; // Min body height [pips]
...
void InitIndicators(void)
  {
   // Moving Average of Oscillator (Close, 8, 42, 8), Level: 0.3641
   ...
   // Standard Deviation (Close, Simple, 27), Level: 6.5295
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Moving Average of Oscillator","listIndexes":[5,3,0,0,0],"numValues":[8,42,8,0.3641,0,0]},{"name":"Directional Indicators","listIndexes":[2,0,0,0,0],"numValues":[11,0,0,0,0,0]}],"closeFilters":[{"name":"Standard Deviation","listIndexes":[2,3,0,0,0],"numValues":[27,6.5295,0,0,0,0]},{"name":"Candle Color","listIndexes":[0,0,0,0,0],"numValues":[49,4,0,0,0,0]}]} */
