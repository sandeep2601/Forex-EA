...
static input int    Magic_Number = 1281132007; // Magic number
...
static input string ___0______   = "------"; // --- Stochastic ---
       input int    Ind0Param0   =       26; // %K Period
       input int    Ind0Param1   =        5; // %D Period
       input int    Ind0Param2   =        6; // Slowing
       input double Ind0Param3   =     20.0; // Level
...
static input string ___2______   = "------"; // --- Standard Deviation ---
       input int    Ind2Param0   =       34; // Period
       input double Ind2Param1   =   0.0000; // Level

static input string ___3______   = "------"; // --- Standard Deviation ---
       input int    Ind3Param0   =       36; // Period
       input double Ind3Param1   = 1279.0000; // Level

static input string ___4______   = "------"; // --- Pin Bar ---
       input int    Ind4Param0   =        3; // Max body part %
       input int    Ind4Param1   =       15; // Min wick part %
...
void InitIndicators(void)
  {
   ...
   // Standard Deviation (Close, Simple, 36), Level: 1279.0000
   indHandlers[0][3][0] = iStdDev(NULL, 0, Ind3Param0, 0, MODE_SMA, PRICE_CLOSE);
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET FTMO; BTCUSD; M1 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Stochastic","listIndexes":[6,0,0,0,0],"numValues":[26,5,6,20,0,0]},{"name":"Awesome Oscillator","listIndexes":[3,0,0,0,0],"numValues":[0,0,0,0,0,0]},{"name":"Standard Deviation","listIndexes":[7,3,0,0,0],"numValues":[34,0,0,0,0,0]},{"name":"Standard Deviation","listIndexes":[3,3,0,0,0],"numValues":[36,1279,0,0,0,0]}],"closeFilters":[{"name":"Pin Bar","listIndexes":[0,0,0,0,0],"numValues":[3,15,0,0,0,0]}]} */
