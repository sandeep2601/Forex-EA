...
static input int    Magic_Number = 1472317460; // Magic number
...
static input string ___1______   = "------"; // --- Awesome Oscillator ---
       input double Ind1Param0   =  -3.5659; // Level
...
void InitIndicators(void)
  {
   // Moving Average of Oscillator (Close, 11, 50, 12), Level: 0.0000
   ...
   // Awesome Oscillator, Level: -3.5659
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Moving Average of Oscillator","listIndexes":[5,3,0,0,0],"numValues":[11,50,12,0,0,0]}],"closeFilters":[{"name":"Awesome Oscillator","listIndexes":[3,0,0,0,0],"numValues":[-3.5659,0,0,0,0,0]},{"name":"RSI","listIndexes":[3,3,0,0,0],"numValues":[10,11,0,0,0,0]}]} */
