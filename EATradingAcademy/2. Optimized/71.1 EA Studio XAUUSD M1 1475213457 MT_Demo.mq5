...
static input int    Magic_Number = 1682275532; // Magic number
...
static input string ___2______   = "------"; // --- Bulls Power ---
       ...
       input double Ind2Param1   =  -3.7004; // Level
...
void InitIndicators(void)
  {
   // Alligator (Smoothed, Median, 27, 22, 22, 8, 10, 3)
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Alligator","listIndexes":[6,3,4,0,0],"numValues":[27,22,22,8,10,3]},{"name":"Stochastic Signal","listIndexes":[2,0,0,0,0],"numValues":[18,5,12,0,0,0]}],"closeFilters":[{"name":"Bulls Power","listIndexes":[4,0,0,0,0],"numValues":[25,-3.7004,0,0,0,0]},{"name":"Accelerator Oscillator","listIndexes":[2,0,0,0,0],"numValues":[1.98,0,0,0,0,0]}]} */
