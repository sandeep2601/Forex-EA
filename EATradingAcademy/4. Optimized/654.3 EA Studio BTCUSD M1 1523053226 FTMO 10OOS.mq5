...
static input int    Magic_Number = 1523053226; // Magic number
...
void ManageClose(void)
  {
   ...
   bool   ind2long  = ind2val1 < Ind2Param0 - sigma;
   bool   ind2short = ind2val1 > -Ind2Param0 + sigma;
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Stochastic","listIndexes":[5,0,0,0,0],"numValues":[8,2,4,26.2,0,0]}],"closeFilters":[{"name":"Accelerator Oscillator","listIndexes":[2,0,0,0,0],"numValues":[254,0,0,0,0,0]},{"name":"Awesome Oscillator","listIndexes":[3,0,0,0,0],"numValues":[-274.5,0,0,0,0,0]}]} */
