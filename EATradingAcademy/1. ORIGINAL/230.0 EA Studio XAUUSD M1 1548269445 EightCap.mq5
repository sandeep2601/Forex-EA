...
static input int    Magic_Number = 1548269445; // Magic number
...
static input string ___0______   = "------"; // --- Bollinger Bands ---
       ...
       input double Ind0Param1   =     2.76; // Deviation

static input string ___1______   = "------"; // --- ADX ---
       input int    Ind1Param0   =       41; // Period
       input double Ind1Param1   =     27.0; // Level
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Bollinger Bands","listIndexes":[2,3,0,0,0],"numValues":[19,2.76,0,0,0,0]}],"closeFilters":[{"name":"ADX","listIndexes":[5,0,0,0,0],"numValues":[41,27,0,0,0,0]}]} */
