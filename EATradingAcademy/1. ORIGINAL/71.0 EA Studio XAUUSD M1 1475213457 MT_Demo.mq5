...
static input int    Magic_Number = 1475213457; // Magic number
...
static input string ___0______   = "------"; // --- Alligator ---
       input int    Ind0Param0   =       27; // Jaws period
       input int    Ind0Param1   =       22; // Jaws shift
       input int    Ind0Param2   =       22; // Teeth period
       input int    Ind0Param3   =       10; // Teeth shift
       input int    Ind0Param4   =       10; // Lips period
       input int    Ind0Param5   =        3; // Lips shift

static input string ___1______   = "------"; // --- Stochastic Signal ---
       input int    Ind1Param0   =       17; // %K Period
       input int    Ind1Param1   =        5; // %D Period
       input int    Ind1Param2   =       12; // Slowing

static input string ___2______   = "------"; // --- Bulls Power ---
       input int    Ind2Param0   =       26; // Period
       input double Ind2Param1   =  -3.7000; // Level

static input string ___3______   = "------"; // --- Accelerator Oscillator ---
       input double Ind3Param0   =   1.9800; // Level
...
void InitIndicators(void)
  {
   // Alligator (Smoothed, Median, 27, 22, 22, 10, 10, 3)
   indHandlers[0][0][0] = iAlligator(NULL, 0, Ind0Param0, Ind0Param1, Ind0Param2, Ind0Param3, Ind0Param4, Ind0Param5, MODE_SMMA, PRICE_MEDIAN);
   if(Show_inds) ChartIndicatorAdd(0, 0, indHandlers[0][0][0]);
   // Stochastic Signal (17, 5, 12)
...
void ManageClose(void)
  {
   ...
   bool   ind3long  = ind3val1 > Ind3Param0 + sigma;
   bool   ind3short = ind3val1 < -Ind3Param0 - sigma;
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Alligator","listIndexes":[6,3,4,0,0],"numValues":[27,22,22,10,10,3]},{"name":"Stochastic Signal","listIndexes":[2,0,0,0,0],"numValues":[17,5,12,0,0,0]}],"closeFilters":[{"name":"Bulls Power","listIndexes":[4,0,0,0,0],"numValues":[26,-3.7,0,0,0,0]},{"name":"Accelerator Oscillator","listIndexes":[2,0,0,0,0],"numValues":[1.98,0,0,0,0,0]}]} */
