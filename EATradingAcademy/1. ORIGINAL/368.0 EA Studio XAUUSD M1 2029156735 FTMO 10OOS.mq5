...
static input int    Magic_Number = 2029156735; // Magic number
...
static input string ___0______   = "------"; // --- Moving Average of Oscillator ---
       input int    Ind0Param0   =        9; // Fast EMA
       input int    Ind0Param1   =       47; // Slow EMA
       input int    Ind0Param2   =        8; // MACD SMA
       input double Ind0Param3   =   0.3661; // Level
...
static input string ___2______   = "------"; // --- Standard Deviation ---
       input int    Ind2Param0   =       29; // Period
       input double Ind2Param1   =   6.5800; // Level

static input string ___3______   = "------"; // --- Candle Color ---
       input int    Ind3Param0   =       41; // Min body height [pips]
       input int    Ind3Param1   =        4; // Consecutive candles
...
void InitIndicators(void)
  {
   // Moving Average of Oscillator (Close, 9, 47, 8), Level: 0.3661
   ...
   // Standard Deviation (Close, Simple, 29), Level: 6.5800
...
int GetEntrySignal(void)
  {
   ...
   // Directional Indicators (11)
   double ind1buffer0[]; CopyBuffer(indHandlers[0][1][0], 1, 1, 2, ind1buffer0);
   double ind1buffer1[]; CopyBuffer(indHandlers[0][1][0], 2, 1, 2, ind1buffer1);
...
//+------------------------------------------------------------------+
/*STRATEGY MARKET FTMO; XAUUSD; M1 */
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Moving Average of Oscillator","listIndexes":[5,3,0,0,0],"numValues":[9,47,8,0.3661,0,0]},{"name":"Directional Indicators","listIndexes":[2,0,0,0,0],"numValues":[11,0,0,0,0,0]}],"closeFilters":[{"name":"Standard Deviation","listIndexes":[2,3,0,0,0],"numValues":[29,6.58,0,0,0,0]},{"name":"Candle Color","listIndexes":[0,0,0,0,0],"numValues":[41,4,0,0,0,0]}]} */
