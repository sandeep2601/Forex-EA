...
static input int    Magic_Number = 1121941433; // Magic number
...
static input string ___0______   = "------"; // --- Stochastic ---
       input int    Ind0Param0   =        7; // %K Period
       input int    Ind0Param1   =        2; // %D Period
       input int    Ind0Param2   =        3; // Slowing
       input double Ind0Param3   =     61.0; // Level
...
static input string ___2______   = "------"; // --- Awesome Oscillator ---
       input double Ind2Param0   = -305.0000; // Level
...
void InitIndicators(void)
  {
   ...
   // Awesome Oscillator, Level: -305.0000
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Stochastic","listIndexes":[5,0,0,0,0],"numValues":[7,2,3,61,0,0]}],"closeFilters":[{"name":"Accelerator Oscillator","listIndexes":[2,0,0,0,0],"numValues":[254,0,0,0,0,0]},{"name":"Awesome Oscillator","listIndexes":[3,0,0,0,0],"numValues":[-305,0,0,0,0,0]}]} */
