...
static input int    Magic_Number = 1572496693; // Magic number
...
static input string ___4______   = "------"; // --- Pin Bar ---
       input int    Ind4Param0   =        4; // Max body part %
       input int    Ind4Param1   =       24; // Min wick part %
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Stochastic","listIndexes":[6,0,0,0,0],"numValues":[6,5,3,20,0,0]},{"name":"Awesome Oscillator","listIndexes":[3,0,0,0,0],"numValues":[0,0,0,0,0,0]},{"name":"Standard Deviation","listIndexes":[7,3,0,0,0],"numValues":[34,0,0,0,0,0]},{"name":"Standard Deviation","listIndexes":[3,3,0,0,0],"numValues":[36,1279,0,0,0,0]}],"closeFilters":[{"name":"Pin Bar","listIndexes":[0,0,0,0,0],"numValues":[4,24,0,0,0,0]}]} */
