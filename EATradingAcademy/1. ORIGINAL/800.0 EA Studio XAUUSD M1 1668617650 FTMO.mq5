...
static input int    Magic_Number = 1668617650; // Magic number
...
static input string ___0______   = "------"; // --- Moving Average of Oscillator ---
       input int    Ind0Param0   =       21; // Fast EMA
       input int    Ind0Param1   =       50; // Slow EMA
       input int    Ind0Param2   =       12; // MACD SMA
       input double Ind0Param3   =   0.0000; // Level

static input string ___1______   = "------"; // --- Awesome Oscillator ---
       input double Ind1Param0   =  -3.5000; // Level

static input string ___2______   = "------"; // --- RSI ---
       input int    Ind2Param0   =       10; // Period
       input int    Ind2Param1   =       11; // Level
...
void InitIndicators(void)
  {
   // Moving Average of Oscillator (Close, 21, 50, 12), Level: 0.0000
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Moving Average of Oscillator","listIndexes":[5,3,0,0,0],"numValues":[21,50,12,0,0,0]}],"closeFilters":[{"name":"Awesome Oscillator","listIndexes":[3,0,0,0,0],"numValues":[-3.5,0,0,0,0,0]},{"name":"RSI","listIndexes":[3,3,0,0,0],"numValues":[10,11,0,0,0,0]}]} */
