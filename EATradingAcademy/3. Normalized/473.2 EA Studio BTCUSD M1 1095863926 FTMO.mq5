...
static input int    Magic_Number = 1095863926; // Magic number
...
static input string ___3______   = "------"; // --- Pin Bar ---
       ...
       input int    Ind3Param1   =       15; // Min wick part %
