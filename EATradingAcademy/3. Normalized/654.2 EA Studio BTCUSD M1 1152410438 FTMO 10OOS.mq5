...
static input int    Magic_Number = 1152410438; // Magic number
...
static input string ___0______   = "------"; // --- Stochastic ---
       ...
       input double Ind0Param3   =     26.0; // Level
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Stochastic","listIndexes":[5,0,0,0,0],"numValues":[6,2,4,26,0,0]}],"closeFilters":[{"name":"Accelerator Oscillator","listIndexes":[2,0,0,0,0],"numValues":[254,0,0,0,0,0]},{"name":"Awesome Oscillator","listIndexes":[3,0,0,0,0],"numValues":[-274.5,0,0,0,0,0]}]} */
