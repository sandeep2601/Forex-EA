//
// Prop Firm Robot by EA Trading Academy
// Website: https://eatradingacademy.com/
//
// Copyright 2024, Forex Academy
//
// Risk Disclosure
//
...
#property copyright "Forex Academy"
#property version   "7.0"
#property strict

static input string _Properties_ = "------"; // --- Expert Properties ---
static input int    Magic_Number = 1599046594; // Magic number
...
static input int    MaxDailyLoss =      490; // Maximum daily loss (currency)
...
static input int    Min_Equity   =     9010; // Minimum equity (currency)
static input double MaxEquity_DD =        0; // Maximum equity drawdown %
static input int    Max_Equity   =    11005; // Maximum equity (currency)
...
string robotUserName = "Petko Aleksandrov";
...
void InitIndicators(void)
  {
   ...
   indHandlers[0][1][0] = iBullsPower(NULL, 0, Ind1Param0);
