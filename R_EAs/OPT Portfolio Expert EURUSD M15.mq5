...
static input int    Magic_Number = 1399051236; // Magic number
...
static input string ___0______   = "------"; // --- Moving Average ---
       ...
       input int    Ind0Param1   =       16; // Shift

static input string ___1______   = "------"; // --- Williams' Percent Range ---
       input int    Ind1Param0   =        5; // Period
       input double Ind1Param1   =    -96.1; // Level

static input string ___2______   = "------"; // --- Commodity Channel Index ---
       input int    Ind2Param0   =       31; // Period
       input int    Ind2Param1   =        0; // Level

static input string ___3______   = "------"; // --- RSI ---
       input int    Ind3Param0   =       10; // Period
       input int    Ind3Param1   =       13; // Level
...
void InitIndicators(void)
  {
   // Moving Average (Simple, Close, 13, 16)
   ...
   // Williams' Percent Range (5), Level: -96.1
   indHandlers[0][1][0] = iWPR(NULL, 0, Ind1Param0);
   ...
   // RSI (Close, 10), Level: 13
   indHandlers[0][3][0] = iRSI(NULL, 0, Ind3Param0, PRICE_CLOSE);
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":1,"stopLoss":65,"takeProfit":75,"useStopLoss":true,"useTakeProfit":true,"isTrailingStop":false},"openFilters":[{"name":"Moving Average","listIndexes":[4,0,3,0,0],"numValues":[13,16,0,0,0,0]},{"name":"Williams' Percent Range","listIndexes":[4,0,0,0,0],"numValues":[5,-96.1,0,0,0,0]},{"name":"Commodity Channel Index","listIndexes":[0,5,0,0,0],"numValues":[31,0,0,0,0,0]}],"closeFilters":[{"name":"RSI","listIndexes":[3,3,0,0,0],"numValues":[10,13,0,0,0,0]}]} */
