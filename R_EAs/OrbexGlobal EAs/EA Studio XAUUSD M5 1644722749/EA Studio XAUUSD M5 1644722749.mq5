...
static input int    Magic_Number = 1644722749; // Magic number
...
static input string ___2______   = "------"; // --- Bears Power ---
       ...
       input double Ind2Param1   =  17.0000; // Level

static input string ___3______   = "------"; // --- Pin Bar ---
       input int    Ind3Param0   =        9; // Max body part %
       input int    Ind3Param1   =       35; // Min wick part %
...
/*STRATEGY CODE {"properties":{"entryLots":1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":0,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Directional Indicators","listIndexes":[1,0,0,0,0],"numValues":[25,0,0,0,0,0]},{"name":"Directional Indicators","listIndexes":[2,0,0,0,0],"numValues":[31,0,0,0,0,0]}],"closeFilters":[{"name":"Bears Power","listIndexes":[2,0,0,0,0],"numValues":[21,17,0,0,0,0]},{"name":"Pin Bar","listIndexes":[0,0,0,0,0],"numValues":[9,35,0,0,0,0]}]} */
