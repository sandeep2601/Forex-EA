...
static input int    Magic_Number = 1576447310; // Magic number
...
static input string ___0______   = "------"; // --- Williams' Percent Range ---
       input int    Ind0Param0   =       29; // Period
       input double Ind0Param1   =    -20.0; // Level

static input string ___1______   = "------"; // --- Alligator ---
       input int    Ind1Param0   =       18; // Jaws period
       input int    Ind1Param1   =       15; // Jaws shift
       input int    Ind1Param2   =       15; // Teeth period
       input int    Ind1Param3   =       13; // Teeth shift
       input int    Ind1Param4   =       13; // Lips period
...
static input double Max_Daily_DD =     2.00; // Maximum daily drawdown %
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Williams' Percent Range","listIndexes":[0,0,0,0,0],"numValues":[29,-20,0,0,0,0]},{"name":"Alligator","listIndexes":[6,3,4,0,0],"numValues":[18,15,15,13,13,5]}],"closeFilters":[{"name":"Candle Color","listIndexes":[1,0,0,0,0],"numValues":[36,5,0,0,0,0]}]} */
