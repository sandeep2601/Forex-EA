...
static input int    Magic_Number = 1744992796; // Magic number
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Bollinger Bands","listIndexes":[1,3,0,0,0],"numValues":[15,1.83,0,0,0,0]},{"name":"Moving Averages Crossover","listIndexes":[1,0,0,0,0],"numValues":[11,46,0,0,0,0]}],"closeFilters":[{"name":"Standard Deviation","listIndexes":[5,3,0,0,0],"numValues":[21,6.4,0,0,0,0]}]} */
