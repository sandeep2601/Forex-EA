...
static input int    Magic_Number = 1294077728; // Magic number
...
void InitIndicators(void)
  {
   ...
   // Moving Averages Crossover (Simple, Simple, 11, 43)
   ...
   // Standard Deviation (Close, Simple, 21), Level: 6.4000
...
/*STRATEGY CODE {"properties":{"entryLots":0.1,"tradeDirectionMode":0,"oppositeEntrySignal":0,"stopLoss":100,"takeProfit":100,"useStopLoss":false,"useTakeProfit":false,"isTrailingStop":false},"openFilters":[{"name":"Bollinger Bands","listIndexes":[1,3,0,0,0],"numValues":[16,1.84,0,0,0,0]},{"name":"Moving Averages Crossover","listIndexes":[1,0,0,0,0],"numValues":[11,43,0,0,0,0]}],"closeFilters":[{"name":"Standard Deviation","listIndexes":[5,3,0,0,0],"numValues":[21,6.4,0,0,0,0]}]} */
